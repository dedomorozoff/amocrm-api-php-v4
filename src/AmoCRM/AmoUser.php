...
class AmoUser extends AmoObject
{
    /**
     ...
     *
     */
    public function addContacts($contacts): AmoUser
    {
     ...
     * @return AmoLead
     */
    public function setCatalogElements(array $catalogElements): AmoUser
    {
     ...
     * @return AmoLead
     */
    public function addCompany(int $companyId) :AmoUser
    {
     ...
     * @return AmoLead
     */
    public function removeContacts($contacts): AmoUser
    {
        if (! is_array($contacts)) {
            $contacts = [ $contacts ];
        }
     ...
     * @return AmoLead
     */
    public function removeCompany(int $companyId): AmoUser
    {
